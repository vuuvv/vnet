...
namespace vuuvv.utils
{
    ...
    {
        public static string dbpath = HttpContext.Current.Server.MapPath("~/App_Data/joyou.db");
        ...
        {
            Type ot = obj.GetType();
            if (ClassHelper.IsNullable(t))
                t = ClassHelper.GetNullableType(t);
            if (ot == t)
                return obj;
        ...
        public static object FetchDataFromReader(object obj, DbDataReader reader)
        {
            Type t = obj.GetType();
            ...
            foreach (string col in cols)
            {
                ...
                if (f != null)
                {
                    ...
                    if (value == DBNull.Value)
                        ...
                        value = ConvertTo(reader[col], f.FieldType);
